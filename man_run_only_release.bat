@echo off
REM ============================================================
REM  VBox GPU Bridge - Run Guest Only (RELEASE build)
REM  Host must be running (Release build).
REM  Usage: man_run_only_release.bat [test_name]
...
echo [Release] Running %TEST_EXE% %TEST_ARGS%
cd /d "%TEST_DIR%"
"%TEST_EXE%" %TEST_ARGS%
